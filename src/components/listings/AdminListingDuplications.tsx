...
// Component interface
interface AdminListingDuplicationsProps {
  customerId: string;
  storeName: string;
}

const AdminListingDuplications: React.FC<AdminListingDuplicationsProps> = ({
  customerId,
  storeName,
}) => {
  ...
  const { optimizeText } = useOptimizeListing();
        ...
        prev.map((listing) =>
          listing.id === selectedListing.id
            ? {
                ...
                duplicatedAt: currentDate,
                duplicates: [
                  ...(listing.duplicates || []).filter(
                    (d) => d.listingId !== newDuplicate.listingId,
                  ),
                  newDuplicate,
                ],
              }
  ...
  }, [selectedSegment, customerId, fetchDuplicates]);
  ...
  return (
    <div style={{ padding: "16px" }}>
      <Tabs
        ...
        onChange={(key) =>
          setSelectedSegment(key as "duplication" | "duplicates")
        }
        type="card"
      >
                          ...
                          >
                            ...
                            >
                              ...
                              <div>
                                ...
                                >
                                  If you&apos;re adding this duplicate to
                                  another section, input the section name here
                                </Text>
                                <Input
                                  value={section}
                              ...
                              <div>
                                ...
                                >
                                  <Space>
                                    ...
                                    />
                                    <Text type="secondary">
                                      ({getTagCount(editedTags)}/{MAX_TAGS}{" "}
                                      tags)
                                    </Text>
                                  </Space>
                                  <Space>
            ...
            <Table
              ...
              expandable={{
                expandedRowRender: (record) => {
                  ...
                  const originalListing = allListings.find(
                    (l) => l.listingID === record.duplicatedFrom,
                  );
                            ...
                            >
                              ...
                              <div>
                                ...
                                <div
                                  style={{ marginLeft: 8 }}
                                  dangerouslySetInnerHTML={sanitizeHtml(
                                    originalListing?.listingDescription || "",
                                  )}
                                />
                              </div>
                              <div>
...
export default AdminListingDuplications;
