...
const MeetingBooking: React.FC = () => {
  ...
  return (
    ...
    >
      <Content
        style={{ padding: "64px 32px", maxWidth: "1400px", margin: "0 auto" }}
      >
        {/* Header Section */}
        <div style={{ marginBottom: 48 }}>
          ...
          <Title
            level={2}
            style={{ fontSize: 16, fontWeight: "normal", color: "#666" }}
          >
            ...
            <Space direction="vertical" size={24} style={{ width: "100%" }}>
              ...
              >
                ...
                <Paragraph style={{ fontSize: 18 }}>
                  Our team will guide you through our services, answer your
                  questions, and help you determine the best solution for your
                  needs. The call typically lasts about 30 minutes.
                </Paragraph>
              </Card>
