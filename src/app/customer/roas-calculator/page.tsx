...
import { Layout, Typography, Card, Input, Space, Popover } from "antd";
import {
  DollarOutlined,
  InfoCircleOutlined,
  UpOutlined,
...
const ROASCalculator: React.FC = () => {
  ...
  return (
    <Layout
      style={{ minHeight: "100vh", background: "white", padding: "16px" }}
    >
        ...
        >
          <Space direction="vertical" size={40} style={{ width: "100%" }}>
            ...
            <div>
              <Text
                strong
                style={{ fontSize: 18, display: "block", marginBottom: 12 }}
              >
                Income (Revenue)
              </Text>
            ...
            {/* Results Section */}
            <Card
              style={{ background: "#f5f5f5", borderRadius: 24, padding: 32 }}
            >
              <Space direction="vertical" size={32} style={{ width: "100%" }}>
                ...
                <Card style={{ borderRadius: 16 }}>
                  ...
                  <Title style={{ color: "#7CD4CC", margin: 0 }}>
                    ${maxAdCost.toFixed(2)}
                  </Title>
                  <Text type="secondary">
                    Maximum amount you can spend on ads per product
                  </Text>
                </Card>
                ...
                <Card style={{ borderRadius: 16 }}>
                      ...
                      content={
                        <div style={{ maxWidth: 400 }}>
                          <Space direction="vertical" size={16}>
                            <Text>
                              ROAS (Return on Ad Spend) varies by product.
                              Here&apos;s an example of different products
                              and their ROAS performance:
                            </Text>
                            <div
                              style={{
                                background: "#f5f5f5",
                            ...
                            <Text>
                              Higher ROAS means better ad performance. Aim for a
                              ROAS above your minimum to ensure profitability.
                            </Text>
                          </Space>
                        </div>
                      }
                  ...
                  <Title style={{ color: "#FFB6C1", margin: 0 }}>
                    {minRoas.toFixed(2)}x
                  </Title>
                  <Text>
                    For every $1 spent on ads, you need to make $
                    {minRoas.toFixed(2)} to break even.
                  </Text>
                </Card>
              </Space>
            </Card>
